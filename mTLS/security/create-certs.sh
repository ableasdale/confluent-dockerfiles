# TODO -ext "SAN:c=DNS:localhost,IP:127.0.0.1"
echo "Step 1: Root Certificate (CA)"
openssl req -new -newkey rsa:4096 -days 365 -x509 -subj "/CN=Kafka-Security-CA" -keyout ca-key -out ca-cert -nodes
# Broker
echo "Step 2: Server Keystore"
keytool -genkey -keystore kafka.server.keystore.jks -validity 365 -storepass confluent -keypass confluent -dname "CN=broker" -storetype pkcs12 -keyalg RSA
